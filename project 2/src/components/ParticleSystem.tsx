...
const ParticleSystem: React.FC<ParticleSystemProps> = ({ mousePosition, isTextHovered }) => {
  const canvasRef = useRef<HTMLCanvasElement>(null);
  const particlesRef = useRef<Particle[]>([]);
  const animationRef = useRef<number>();

  const colors = ['#ec4899', '#8b5cf6', '#14b8a6', '#06b6d4', '#f97316'];
